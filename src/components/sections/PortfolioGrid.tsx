    ...
    <section className="relative bg-[#F7FFF9] py-20 dark:bg-[#060C0A] md:py-28">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 md:px-10">
        ...
        <div className="mb-10 md:mb-14" role="group" aria-label="Filtres par catégorie">
          <p className="mb-4 font-bricolage text-[11px] font-semibold uppercase tracking-[0.22em] text-[#9CA3AF]">
            Filtrer par :
          </p>
                ...
                <button
                  ...
                  className={`shrink-0 rounded-full px-4 py-2 text-[12px] font-semibold transition-all duration-300 ${
                    isActive
                      ...
                      : "border border-[#00E87A]/10 bg-white/60 text-[#6B7280] hover:border-[#00E87A]/30 hover:text-[#071510] dark:bg-[#071510]/40 dark:text-[#9CA3AF] dark:hover:border-[#00E87A]/30 dark:hover:text-[#F0FAF4]"
                  }`}
                >
                  {f.label} ({count})
                </button>
